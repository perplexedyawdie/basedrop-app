      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
          ...
          <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">Drag and drop anything that sparks your creativity – images, videos, text, links – and see it all organized in your visual workspace. Whether you&apos;re brainstorming brand concepts, designing your dream room, or planning your next adventure, make it happen visually.</p>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 className="text-gray-900 text-lg title-font font-semibold mb-2">Create your account</h2>
              <p className="leading-relaxed text-base">Sign up for free and start curating your ultimate inspiration space.</p>
            </div>
          </div>
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 className="text-gray-900 text-lg title-font font-semibold mb-2">Download extension</h2>
              ...
              <button className="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
                <GithubIcon />
                <Link rel="noopener noreferrer" target="_blank" href={"https://github.com/perplexedyawdie/basedrop-clipper"} className="ml-4 flex items-start flex-col leading-none">
          ...
          <div className="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 className="text-gray-900 text-lg title-font font-semibold mb-2">Drag, Drop, Create</h2>
              <p className="leading-relaxed text-base">Unleash your creativity and bring those big ideas to life.</p>
            </div>
          </div>
        </div>
      </section>
